...
wav_file=$DATA_DIR/data/tst-COMMON/wav
yaml_file=$DATA_DIR/tst-COMMON.$SEGTYPE.yaml
...
python $WORKING_DIR/app.py $DATA_DIR/data/tst-COMMON/txt \
    ...
    --scoring sacrebleu --lenpen 1.0 --quiet --port $PORT &
